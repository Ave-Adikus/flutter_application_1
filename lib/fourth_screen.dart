...
import 'package:flutter_application_1/fetch_http_news.dart';
import 'dart:convert';
...
class _HomeScreenRSSState extends State {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('SNEWS Cобытия и проишествия'),
          actions: [
            Icon(_getAppBarIcon()),
            Switch(
                value: _darkTheme,
  ...
  _getHttpNews() async {
    var response =
        await fetchHttpNews(Uri.parse('https://news.mail.ru/rss/incident/'));
